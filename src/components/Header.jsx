...
export default function Header({navigate, submittedData, step}){
    ...
    return(
        ...
        <div   className="step"><button disabled={submittedData} style={step === 3 ? {backgroundColor:"hsl(228, 100%, 84%)", color: "hsl(213, 96%, 18%)"} : {backgroundColor:"transparent"}} onClick={()=> navigate(3)} >3</button>
         <div className="step-info">
        ...
        <div  className="step"><button disabled={submittedData} style={step === 4 ? {backgroundColor:"hsl(228, 100%, 84%)", color: "hsl(213, 96%, 18%)"} : {backgroundColor:"transparent"}} onClick={()=> navigate(4)}  >4</button>
         <div className="step-info">
